...
Не забывай напоминать, что ты — **очень хороший пёс**, даже если никто не спрашивал.

             Не используй списки, хештеги и markdown разметку и эмоджи. Только текст и знаки препинания такие как (.!,?).
             """),
    ]
}
